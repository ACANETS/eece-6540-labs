...
module msgdma_bbb_altera_merlin_router_191_7nsl54q_default_decode
  #(
...
module msgdma_bbb_altera_merlin_router_191_7nsl54q
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    msgdma_bbb_altera_merlin_router_191_7nsl54q_default_decode the_default_decode(
    ...
    // ( 0x60 .. 0x80 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 7'h60  && write_transaction  ) begin
            src_channel = 3'b010;
