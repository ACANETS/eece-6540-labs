// ase_altera_merlin_traffic_limiter_191_ugfb2ya.v

// Generated using ACDS version 19.2 57

`timescale 1 ps / 1 ps
module ase_altera_merlin_traffic_limiter_191_ugfb2ya #(
		parameter IMPL                  = "reg",
		parameter SYMBOLS_PER_BEAT      = 1,
		parameter BITS_PER_SYMBOL       = 6,
		parameter FIFO_DEPTH            = 17,
		parameter CHANNEL_WIDTH         = 0,
		parameter ERROR_WIDTH           = 0,
		parameter USE_PACKETS           = 0,
		parameter EMPTY_LATENCY         = 1,
		parameter ALMOST_FULL_THRESHOLD = 17,
	...
	ase_alt_hiconnect_sc_fifo_191_7qtmpqq #(
		.IMPL                  (IMPL),
