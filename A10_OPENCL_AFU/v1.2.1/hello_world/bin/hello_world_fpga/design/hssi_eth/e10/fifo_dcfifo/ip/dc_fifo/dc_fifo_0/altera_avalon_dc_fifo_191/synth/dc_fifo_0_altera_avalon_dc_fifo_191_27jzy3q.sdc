...
#-------------------------------------------------------------------------------
set all_dc_fifo [get_entity_instances dc_fifo_0_altera_avalon_dc_fifo_191_27jzy3q]
...
set mem_regs [get_registers -nowarn *|dc_fifo_0_altera_avalon_dc_fifo_191_27jzy3q:*|mem*];
if {![llength [query_collection -report -all $mem_regs]] > 0} {
    set mem_regs [get_registers -nowarn dc_fifo_0_altera_avalon_dc_fifo_191_27jzy3q:*|mem*];
}

set internal_out_payload_regs [get_registers -nowarn *|dc_fifo_0_altera_avalon_dc_fifo_191_27jzy3q:*|internal_out_payload*];
