...
module ddr_board_altera_merlin_router_191_n3jyaya_default_decode
  #(
  ...
  (output [636 - 636 : 0] default_destination_id,
...
module ddr_board_altera_merlin_router_191_n3jyaya
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    ddr_board_altera_merlin_router_191_n3jyaya_default_decode the_default_decode(
